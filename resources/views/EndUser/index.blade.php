...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-md-6 ">
                    <div class="about-img"><img src="{{asset('EndUserAssets')}}/img/about.jpg" class="img-responsive"
                                                alt=""></div>
                </div>
                <div class="col-xs-12 col-md-6">
    ...
    @include('EndUser.partials.menu')
    @include('EndUser.partials.gallery')
    @include('EndUser.partials.chefs')
